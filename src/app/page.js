...
import MarkdownRendererModal from '@/components/MarkdownRendererModal';
            ...
            <section className="mt-4">
                ...
                {openModal && selected && (
                    <div
                        ...
                        className="fixed inset-0 z-40 flex items-center justify-center p-2 bg-black/40 backdrop-blur-sm"
                        onClick={(e) => {
                    ...
                    >
                        ...
                        <div
                            ...
                            className={[
                                // lebar responsif
                                'bg-white w-full max-w-3xl rounded-md border border-gray-300 shadow-md',
                                // tinggi maksimum pakai dvh supaya akurat di mobile
                        ...
                        >
                            ...
                            <div className="flex items-start justify-between gap-3 p-4">
                                ...
                                <button
                                    type="button"
                                    onClick={closeNotes}
                                    className="rounded-md border border-gray-300 px-2 py-1 text-xs hover:bg-gray-100 active:scale-95 transition"
                                >
                                    Esc
                                </button>
                            </div>
                            ...
                            <div className="flex-1 overflow-y-auto overscroll-contain p-4">
                                {!isEditing ? (
                                    <>
                                        {/* NOTE: hilangkan whitespace-pre-line di wrapper saat pakai Markdown */}
                                        <MarkdownRendererModal
                                    ...
                                    >
                                        <div className="relative">
                                            ...
                                            <label
                                                ...
                                                className={[
                                                    'pointer-events-none absolute left-3 top-3 text-gray-300',
                                                    'transition-all duration-300 px-1 bg-white',
                                                    'peer-focus:-top-2 peer-focus:text-xs peer-focus:text-blue-600',
                                                    'peer-placeholder-shown:top-3 peer-placeholder-shown:text-sm',
                                                    'peer-[&:not(:placeholder-shown)]:-top-2 peer-[&:not(:placeholder-shown)]:text-xs',
                                                ].join(' ')}
                            ...
                            <div className="p-4 flex justify-between">
                                {!isEditing ? (
                                    <>
                                        <button
                                            type="button"
                                            className="rounded-md bg-red-500 text-white px-3 py-2 text-sm hover:bg-red-600 active:scale-95 transition"
                                            onClick={() =>
                                                askDelete(
                                                    selected.id,
                                                    selected.title
                                        ...
                                        <button
                                            type="button"
                                            className="rounded-md border border-gray-300 px-3 py-2 text-sm hover:bg-gray-50 active:scale-95 transition"
                                            onClick={() => {
                                                setIsEditing(true);
                                    ...
                                    <>
                                        <button
                                            type="button"
                                            className="rounded-md bg-black text-white px-3 py-2 text-sm hover:bg-gray-700 active:scale-95 transition"
                                            onClick={() => {
                                                setIsEditing(false);
                                                setEditTitle(selected.title);
                                                setEditContent(
                                        ...
                                        <button
                                            type="submit"
                                            form="" /* optional: kalau mau submit form di atas, kasih id ke form dan set di sini */
                                            disabled={isUpdating}
                                            onClick={onSubmitEdit}
                                            className="rounded-md border border-gray-300 px-3 py-2 text-sm hover:bg-gray-50 active:scale-95 transition disabled:opacity-60"
                                        >
                                            {isUpdating
                                                ? 'Menyimpan...'
                                                : 'Simpan'}
                    ...
                    {(data?.items ?? []).map((it) => (
                        ...
                        >
                            ...
                            <div className="mt-1 flex-1 overflow-hidden">
                                <div className="mt-1 flex-1 overflow-hidden clamp-4">
